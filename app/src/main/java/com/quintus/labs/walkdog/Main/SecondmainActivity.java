...
import com.quintus.labs.walkdog.Utils.PulsatorLayout;
...
public class SecondmainActivity extends Activity {
    ...
    private Context mContext = SecondmainActivity.this;
...
//        if(prefer.equals("dog") || prefer.isEmpty()) {
//
...
//        }
            ...
            rowItems.add(cards);
            cards = new Cards("4", "Preety Deshmukh", 19, "https://i.ytimg.com/vi/hYvkSHYh_WQ/hqdefault.jpg", "dashing girl", "swiming", 1308);
            rowItems.add(cards);
            ...
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                        ...
                        Toast.makeText(SecondmainActivity.this, "Location Permission Denied. You have to give permission inorder to know the user range ", Toast.LENGTH_SHORT)
                                .show();
                    }
                }
            }
